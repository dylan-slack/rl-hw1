...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        # Personally always use np random choice to do this...
        indcs = np.random.choice(self.obs.shape[0],replace=True,size=batch_size)
        return self.obs[indcs], self.acs[indcs], self.rews[indcs], self.next_obs[indcs], self.terminals[indcs]
